...
- I realize why external third parties are used to instead of the in-built `NewServeMux`. An example is trying to use parameters/variables in the provided URL or figuring out the method type of the request. There are ways of [accomplishing](https://stackoverflow.com/questions/29211241/go-url-parameters-mapping) this but I would like to try to keep my code as clean as possible. Nevertheless, cool to find out about this.
